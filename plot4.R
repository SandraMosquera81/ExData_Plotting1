...
plot(date_time, subset_data$Voltage,type= "l" , xlab = "date time", ylab = "Voltage" )
...
plot(date_time, subset_data$Global_reactive_power, type = "l", ylab = "Global reactive power")
dev.off()